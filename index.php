...
define('MAIL_USERNAME', 'webstore.perfume@gmail.com');
define('MAIL_PASSWORD', 'lnlzzizbarytqfnz');
...
require_once "activities/SentMagazineByEmail.php";
require_once "activities/SearchController.php";
...
uri('/gopy/gui', 'App\SentMagazineByEmail', 'sendByEmail', 'POST');

uri('/chi-tiet/bai-dang/{id}', 'App\ViewPost', 'index');

uri('/sent-email', 'App\SentMagazineByEmail', 'index');
uri('/guibai/sent-email', 'App\SentMagazineByEmail', 'sendPostByEmail', 'POST');
uri('/search', 'App\SearchController', 'index', 'GET');
