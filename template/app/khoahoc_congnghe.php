...
<div class="container-fluid">
    <div class="row mt-4">
        ...
        <div class="col-md-7">
            <div class="row mb-4">
                <div class="col-md-12">
                    <form method="GET" action="<?= url('khoahoccongnghe') ?>" class="d-flex">
                    <div class="row"> 
                    <div class="col-md-7"> 
                ...
                <div class="mb-3 p-3 " style="border-bottom: 2px dotted red; border-left: 2px solid rgb(241,243,244);">
                    ...
                    <div class="text-right mt-2">
                        <div class="d-inline-block mr-3">
                            <img src="./public/banner-image/dowload.png" alt="Download Icon" style="max-width: 2vw; max-height: 3vh;" />
                        </div>
                        <div class="d-inline-block">
                            <img src="./public/banner-image/eyes.png" alt="Eyes Icon" style="max-width: 1.8vw; max-height: 2.8vh;" />
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
