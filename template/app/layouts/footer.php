...
<footer class="footer-area section-gap"
        style="background-image: url('https://png.pngtree.com/background/20210710/original/pngtree-blue-technology-web-banner-picture-image_1038231.jpg'); background-size: cover; background-repeat: no-repeat; height: 30vh;">
    <div style="width: 100%; display: flex; margin-top: 0.5vw;
">
        <div>
            ...
            <div style=" display: flex;">
                ...
                <div>
                    <div style="border-bottom: 0.3vw solid #fff;">
                        <p style="display: flex; flex-direction: column; justify-content: right; align-items: flex-start;">
                            <span style="text-transform: uppercase; font-weight: 700; margin-right: 10px;">Tạp chí khoa học & công nghệ trường Đại học Kinh tế - Kỹ thuật Công nghiệp</span>
                        </p>
                    </div>
                    <p style="font-weight: 700;margin-right: 10px;">JOURNAL OF SCIENCE & TECHNOLOGY UNIVERSITY OF
