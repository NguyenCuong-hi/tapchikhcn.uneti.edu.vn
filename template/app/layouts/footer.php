...
?>
    <style>
     ...
     <footer class="bg-dark text-white py-3" style="background-image: url('https://png.pngtree.com/background/20210710/original/pngtree-blue-technology-web-banner-picture-image_1038231.jpg'); background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="row">
                <div class="col-12 col-md-1 d-flex align-items-start mb-3 mb-md-0">
                    <img src="<?= url('./public/banner-image/logo.png') ?>" id="imgfooter" class="img-fluid mr-3" alt="Logo">
                </div>
                <div class="col-12 col-md-8">
                    <div class="border-bottom mb-2" style="border-bottom-width: 3px; border-bottom-color: #fff;">
                        <p class="m-0 text-uppercase font-weight-bold">
                            Tạp chí khoa học & công nghệ trường Đại học Kinh tế - Kỹ thuật Công nghiệp
                        </p>
                    </div>
                    <p class="font-weight-bold mb-2">JOURNAL OF SCIENCE & TECHNOLOGY UNIVERSITY OF ECONOMICS - TECHNOLOGY FOR INDUSTRIES</p>
                    <div class="row">
